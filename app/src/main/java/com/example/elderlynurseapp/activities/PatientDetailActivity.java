package com.example.elderlynurseapp.activities;
...
import com.example.elderlynurseapp.R;
import com.example.elderlynurseapp.models.*;
...
public class PatientDetailActivity extends ActionBarActivity implements View.OnClickListener {
    ...
    private View mRoomTempView;
    private View mRoomLightView;
    private View mRoomTiltView;
    private View mRoomVibView;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mRoomLightView = findViewById(R.id.patient_detail_room_light);
        mRoomTiltView = findViewById(R.id.patient_detail_room_bedtilt);
        mRoomVibView = findViewById(R.id.patient_detail_room_vibration);
        mRoomTempView = findViewById(R.id.patient_detail_room_temp);
    ...
    private void populatePatientData() {
        ...
        setText(mRoomLightView, "light level", "12 saaLumens");
        setText(mRoomTempView, "Temperature", "72 degrees");
        setText(mRoomTiltView, "Bed Tilt", "140 degrees - 3 hours");
        setText(mRoomVibView, "Vibration Alert", "Low");
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.voicerecord:
                ...
                setText(mRoomLightView, "light level", "15 saaLumens");
                setText(mRoomTempView, "Temperature", "75 degrees");
                setText(mRoomTiltView, "Bed Tilt", "140 degrees - 3 hours");
                setText(mRoomVibView, "Vibration Alert", "Low");
